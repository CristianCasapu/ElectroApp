...
class _UpdateDialogState extends State<UpdateDialog> {
  ...
  void _renunta() {
    if (_faza == _Faza.descarca) {
      // descărcarea observă steagul la următorul bloc și închide dialogul
      setState(() => _anulat = true);
    } else {
      Navigator.pop(context);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: _anulat ? null : _renunta,
            child: Text(_faza == _Faza.descarca ? 'Renunță' : 'Mai târziu'),
          ),
          switch (_faza) {
